...
public class EmployeeService {
    ...
    public ArrayList getAllEmployees()
    {
        ...
        try {
            ...
            String sql = "SELECT employeeId, firstName, lastName, phone, address, gender, age, basicSalary, carAllowance, departmentName, roleName FROM employeedb.employees, employeedb.departments, employeedb.roles where employees.departmentId = departments.departmentId and employees.roleId = roles.roleId order by employeeId;";
...
//                    +"and e.employeeId=?";
    ...
    public ArrayList SearchEmployeesDB(String firstName, String lastName, String gender, String departmentId, String roleId) {
        ...
        try {
            ...
            String sql = "select * from employees e, departments d, roles r "
                    + "where e.departmentId=d.departmentId and e.roleId=r.roleId having firstName like ? and lastName like ? and gender like ? and d.departmentId like ? and r.roleId like ? order by employeeId";
