...
<body style="background-color: #f5f5f5">
    ...
    <form action="SearchEmployee" method="Post">
        <img class="mb-4" src="images/flower-logo.jpg" alt=" logo" style="display: block; margin-left: auto; margin-right: auto" width="150" height="57">
        <br>
    ...
    <tr>
        ...
        <td>
            <div class="form-floating">
                ...
                <div>
    <button class="w-100 btn btn-sm btn-primary" style="background-color: blue; border: none" type="submit">Search in Database</button>
                </div>
    </form>
